...
import { AllDynamicFormDataResponseI, DynamicFormCreateRequest, DynamicFormI, DynamicFormUpdateRequest, FilterFieldI, GetAllDynamicFormResponseI } from "./gis-form-template";
...
export const gisFormTemplateApi = rootApi.injectEndpoints({
  endpoints: (builder) => ({
    ...
    postDynamicForm: builder.mutation<DynamicFormI, DynamicFormCreateRequest>({
      query: (data) => ({
        url: `/custom-form/`,
        method: "POST",
        body: data,
    ...
    updateDynamicForm: builder.mutation<any, DynamicFormUpdateRequest>({
      query: ({ id, data }) => ({
        url: `/custom-form/${id}/`,
        method: "PUT",
        body: data,
    ...
    getAllDynamicFormData: builder.query<AllDynamicFormDataResponseI, { id: string; params: SearchParamsI; propertyId?: string }>({
      query: ({
        id,
        propertyId,
    ...
    updateDynamicFormData: builder.mutation<any,{ id: string; formId: string; data: any }>({
    ...
    deleteDynamicFormData: builder.mutation<any,{ id: string; formId: string }>({
      query: ({ id, formId }) => ({
        url: `/custom-form/${id}/dynamic-form-data/${formId}/`,
        method: "DELETE",
      }),
    ...
    getFilterableFields: builder.query<{ fields: FilterFieldI[] }, { formId: string }>({
      query: ({ formId }) => ({
