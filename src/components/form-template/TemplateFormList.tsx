    ...
    return (
        <>
            ...
            <div className="w-full border p-5 bg-white">
                <div className="mb-5">
                    <TableHeader
                        title="Gis Form Templates"
                        subTitle="View/Search Gis Form Templates"
                        linkTitle={"Add Form Template"}
                        // buttonClick={() => setModalOpen(true)}
                        link={"/form-template/create"}
                    />
                </div>
                {/* searchFilter */}
                        ...
                        <table className="min-w-max w-full">
                            <thead className='bg-theme'>
                                <tr className="bg-primary-blue-900 text-white capitalize text-sm leading-normal">
                                    ...
                                    <th className="py-3 px-6 text-left">{"Template Form Name"}</th>
