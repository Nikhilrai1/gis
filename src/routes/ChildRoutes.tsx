...
import SavedChartsList from "@/pages/protected/chart/SavedChartList";
import SingleChartPage from "@/pages/protected/chart/SingleChart";
...
const ChildRoutes = [
  ...
  {
    path: "chart/single",
    element: <SingleChartPage />,
  },
  {
    path: "chart/list",
    element: <SavedChartsList />,
  },
  {
    path: "info",
    element: <InfoPage />,
